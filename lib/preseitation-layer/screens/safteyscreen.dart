          ...
          child: Column(
            children: [
              SafteyItem(context,
                  ...
                  value: iotCubit.get(context).doors, fun: () async {
              ...
              SafteyItem(context,
                  text: 'Turn Off All Electrical Devices',
                  value: iotCubit.get(context).electric, fun: () async {
              ...
              SafteyItem(context,
                  text: 'Close All Home',
                  value: iotCubit.get(context).allhome, fun: () async {
